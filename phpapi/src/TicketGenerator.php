...
.qr { position: absolute; bottom: 280px; right: 220px; width: 260px; height: 260px; background: white; padding: 5px; border-radius: 8px; }
.table-box { position: absolute; bottom: 255px; left: 320px; width: 288px; height: 188px; text-align: center; line-height: 46px; font-size: 46px; font-weight: bold; color: #003366; }
.seat-box { position: absolute; bottom: 255px; left: 810px; width: 288px; height: 188px; text-align: center; line-height: 46px; font-size: 46px; font-weight: bold; color: #003366; }
</style></head><body>
  <div class="card">
